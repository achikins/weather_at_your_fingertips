...
export default function WeatherCards({
  ...
  if (loading && !monthly?.length) {
    if (showCurrent && !showStats) {
      return (
        <div className="rounded-2xl border border-gray-100 dark:border-white/5 bg-white dark:bg-[#1a2035] px-5 py-4 shadow-sm animate-pulse">
          <div className="h-8 w-24 bg-gray-100 dark:bg-white/5 rounded mb-2" />
